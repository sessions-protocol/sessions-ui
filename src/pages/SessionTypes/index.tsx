...
export default function SessionTypesPage() {
  ...
  const fetchList = async (profileId: string) => {
    ...
    // console.log(sessionTypesByProfile)
    setSessionTypes([
      {
        id: "1",
        recipient: "0x02Ff541f434Cd611F1E5Da22dc234CB3FF2d5e6e",
        durationInSlot: 5,
                  ...
                  <Field name="openBookingDeltaDays">
                    {({ field, form }: any) => (
                      <FormControl className="mb-5">
                        ...
                        <NumberInput
                          defaultValue={formData.openBookingDeltaDays}
                          min={1}
                        ...
                        >
                          <Stack spacing={5} direction="row">
                            ...
                            <Radio
                              ...
                              title="0x001B3B4d0F3714Ca98ba10F6042DaEbF0B1B7b6F"
                            >
                              DAI
                            </Radio>
                            <Radio
